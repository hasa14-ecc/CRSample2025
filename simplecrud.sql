...
-- Dumping structure for table simplecrud.contacts
...
-- Dumping data for table simplecrud.contacts: ~13 rows (approximately)
...
-- Dumping structure for table simplecrud.users
...
-- Dumping data for table simplecrud.users: ~1 rows (approximately)
